...
am__append_1 = tests
am__append_2 = libcrypto.pc libssl.pc openssl.pc
subdir = .
ACLOCAL_M4 = $(top_srcdir)/aclocal.m4
am__aclocal_m4_deps = $(top_srcdir)/m4/ax_add_fortify_source.m4 \
	$(top_srcdir)/m4/ax_check_compile_flag.m4 \
	$(top_srcdir)/m4/check-hardening-options.m4 \
...
ACLOCAL = ${SHELL} '/c/libressl-3.5.3/missing' aclocal-1.16
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = ar
AUTOCONF = ${SHELL} '/c/libressl-3.5.3/missing' autoconf
AUTOHEADER = ${SHELL} '/c/libressl-3.5.3/missing' autoheader
AUTOMAKE = ${SHELL} '/c/libressl-3.5.3/missing' automake-1.16
AWK = gawk
CC = cc
CCAS = cc
CCASDEPMODE = depmode=gcc3
CCASFLAGS = -g -O2 -Wall -std=gnu99 -fno-strict-aliasing  -fno-strict-overflow -fstack-protector-strong 
CCDEPMODE = depmode=gcc3
CFLAGS = -g -O2 -Wall -std=gnu99 -fno-strict-aliasing  -fno-strict-overflow -fstack-protector-strong   -Wno-pointer-sign
CPP = cc -E
CPPFLAGS =  -D_FORTIFY_SOURCE=2
CYGPATH_W = cygpath -w
DEFS = -DPACKAGE_NAME=\"libressl\" -DPACKAGE_TARNAME=\"libressl\" -DPACKAGE_VERSION=\"3.5.3\" -DPACKAGE_STRING=\"libressl\ 3.5.3\" -DPACKAGE_BUGREPORT=\"\" -DPACKAGE_URL=\"\" -DPACKAGE=\"libressl\" -DVERSION=\"3.5.3\" -DSTDC_HEADERS=1 -DHAVE_SYS_TYPES_H=1 -DHAVE_SYS_STAT_H=1 -DHAVE_STDLIB_H=1 -DHAVE_STRING_H=1 -DHAVE_MEMORY_H=1 -DHAVE_STRINGS_H=1 -DHAVE_INTTYPES_H=1 -DHAVE_STDINT_H=1 -DHAVE_UNISTD_H=1 -DHAVE_DLFCN_H=1 -DLT_OBJDIR=\".libs/\" -DSIZEOF_TIME_T=8 -DHAVE_SYMLINK=1 -DHAVE_ENDIAN_H=1 -DHAVE_ERR_H=1 -DHAVE_NETINET_IP_H=1 -DHAVE_SYS_TYPES_H=1 -DHAVE_NETINET_IN_H=1 -DHAVE_ARPA_NAMESER_H=1 -DHAVE_NETDB_H=1 -DHAVE_RESOLV_H=1 -DHAVE_ASPRINTF=1 -DHAVE_MEMMEM=1 -DHAVE_REALLOCARRAY=1 -DHAVE_STRLCAT=1 -DHAVE_STRLCPY=1 -DHAVE_STRNDUP=1 -DHAVE_STRNLEN=1 -DHAVE_STRSEP=1 -DHAVE_TIMEGM=1 -DHAVE_GETPROGNAME=1 -DHAVE_SYSLOG=1 -DHAVE_ACCEPT4=1 -DHAVE_PIPE2=1 -DHAVE_POLL=1 -DHAVE_SOCKETPAIR=1 -DHAVE_ARC4RANDOM=1 -DHAVE_ARC4RANDOM_BUF=1 -DHAVE_ARC4RANDOM_UNIFORM=1 -DHAVE_EXPLICIT_BZERO=1 -DHAVE_TIMINGSAFE_BCMP=1 -DHAVE_TIMINGSAFE_MEMCMP=1 -DHAVE_CLOCK_GETTIME=1 -DHAVE_VA_COPY=1 -DHAVE___VA_COPY=1 -DHAS_GNU_WARNING_LONG=1
DEPDIR = .deps
DLLTOOL = dlltool
DSYMUTIL = 
DUMPBIN = 
...
LN_S = cp -pR
LTLIBOBJS = 
MAKEINFO = ${SHELL} '/c/libressl-3.5.3/missing' makeinfo
MANIFEST_TOOL = :
...
STRIP = strip
VERSION = 3.5.3
abs_builddir = /c/libressl-3.5.3
abs_srcdir = /c/libressl-3.5.3
abs_top_builddir = /c/libressl-3.5.3
abs_top_srcdir = /c/libressl-3.5.3
ac_ct_AR = ar
ac_ct_CC = cc
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /c/libressl-3.5.3/install-sh
...
install-exec-hook:
	@if [ ""C:\Program Files\Common Files\SSL"x" != "x" ]; then \
		OPENSSLDIR="$(DESTDIR)"C:\Program Files\Common Files\SSL""; \
	else \
